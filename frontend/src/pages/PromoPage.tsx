...
export default function PromoPage() {
  ...
  return (
    <div className="bg-background min-h-screen font-body">
      ...
      {/* Header */}
      <div className="relative h-56 md:h-72 bg-cover bg-center" style={{ backgroundImage: "url('/Cat_Diagnostico.png')" }}>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
              {images.map((img, i) => {
                ...
                return (
                  <motion.div
                    key={img.id}
                    className="bg-white border border-outline-variant/30 hover:shadow-xl transition-all group flex flex-col relative"
                  ...
                  >
                    ...
                    <div className="aspect-square overflow-hidden bg-white p-6 border-b border-slate-50">
                      <img
